        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <!-- Topbar Search -->
                    <form method="get" action="{{route('employee_search')}}"
                    ...
                    <div class="container-xl">
                        <div class="table-responsive">
                            <div class="table-wrapper">
                                <div class="table-title" style="background-color:#070163;">
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <h2>Display Employee</h2>
                                        </div>
                                        <div class="col-sm-6">
                                            <a href="registration" class="btn" style="background-color:#F4B619;">
