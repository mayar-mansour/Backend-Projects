                                ...
                                <div class="row justify-content-center">
                                    <div class="col-md-10 col-lg-8 col-xl-5 order-2 order-lg-1">
                                        ...
                                        <form method="POST" class="mx-1 mx-md-4"
                                            action="{{ route('registartion-user') }}" enctype="multipart/form-data">
                                            @csrf
                                            ...
                                            <div class="d-flex flex-row align-items-center mb-4">
                                                ...
                                                <div class="form-outline flex-fill mb-0">
                                                    ...
                                                    class="form-control" /> --}}
                                                    <select list="browsers" name="position_id">
                                            ...
                                            <p class="text-center text-muted mt-5 mb-5">Have already an account? <a
