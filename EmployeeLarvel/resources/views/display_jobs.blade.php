                        ...
                        <div class="table-responsive">
                            <div class="table-wrapper">
                                <div class="table-title">
                                    <div class="row">
                                        <div class="col-sm-6 ">
                                            <h2>Display Positions</h2>
                                        </div>
                                        <div class="col-sm-6">
                                            <a href="job" class="btn btn-success">
                                ...
                                <table class="table table-striped table-hover">
                                    ...
                                    @foreach ($positions as $position)
                                        <tr>
                                            ...
                                            <td>
                                                <form action="{{ route('destroy', $position->id) }}"  method="POST" style="display: flex">

                                                    <a class="btn btn-info text-light mr-2"
                                                        href="{{ route('show_emp', $position->id) }}">Show Employees</a>

                                                    <a class="btn btn-primary text-light mr-2"
                                                        href="{{ route('edit_job', $position->id) }}">Edit</a>
