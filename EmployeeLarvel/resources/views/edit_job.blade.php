                    ...
                    <form
                        ...
                        <div class="input-group">
                            ...
                            <div class="input-group-append">
                                <button class="btn" style="background-color:#58C5C5; color:aliceblue; "
                                    type="button">
                            ...
                            <div>
                                ...
                                <div class="row justify-content-center">
                                    <div class="col-md-10 col-lg-8 col-xl-5 order-2 order-lg-1">
                                        ...
                                        <p class="text-center h1 fw-bold mb-5 mx-1 mx-md-4 mt-2">Update</p>

                                        <form method="POST" class="mx-1 mx-md-4"
                                            action="{{ route('updateJob', $positions->id) }}"
                                            ...
                                            <div class="d-flex flex-row align-items-center mb-4">
                                                ...
                                                <div class="form-outline flex-fill mb-0">
                                                    ...
                                                    <input type="text" name="title" id="form3Example4cd"
                                                        class="form-control"
                                                        value="{{ old('title', $positions->title) }}" />
                                            ...
                                            <div class="d-flex flex-row align-items-center mb-4">
                                                ...
                                                <div class="form-outline flex-fill mb-0">
                                                    ...
                                                    <input type="text" name="code"
                                                        value="{{ old('code', $positions->code) }}" id="form3Example1c"
                                                        class="form-control" />
                                            ...
                                            <div class="d-flex flex-row align-items-center mb-4">
                                                ...
                                                <div class="form-outline flex-fill mb-0">
                                                    ...
                                                    <input type="hidden" name="hidden_id"
                                                        value="{{ $positions->id }}" id="form3Example1c"
                                                        class="form-control" />
                                            ...
                                            <div class="d-flex justify-content-center">
                                                <button type="submit"
                                                    class="btn btn-warning btn-block btn-lg gradient-custom-4 text-body text-light">Update
                                                    Position</button>
                                            </div>
                                    ...
                                    <div
                                        ...
                                        <img src="https://www.insects-control.com/images/jobs.png" class="img-fluid"
                                            alt="Sample image">
